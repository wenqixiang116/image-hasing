...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create an image with vertical color variation to test dhash_vertical properly
        ...
        self.img_vert_resized = self.img_vert.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        ...
        h2 = dhash_vertical(self.img_vert_resized)
