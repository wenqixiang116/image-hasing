...
class TestHashing(unittest.TestCase):
    ...
    def test_dhash_vertical(self):
        ...
        v_split = Image.new('RGB', (100, 100), color='black')
        d = ImageDraw.Draw(v_split)
        d.rectangle([0, 50, 100, 100], fill='white')

        v_split_resized = v_split.resize((90, 90))

        h1 = dhash_vertical(v_split)
        h2 = dhash_vertical(v_split_resized)
        h3 = dhash_vertical(self.img3) # all black image
