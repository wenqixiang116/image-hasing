...
class TestHashing(unittest.TestCase):
    ...
    def test_dhash_vertical(self):
        # create vertically split image
        vert_img1 = Image.new('RGB', (100, 100), color='white')
        d = ImageDraw.Draw(vert_img1)
        d.rectangle([0, 50, 100, 100], fill='black')

        vert_img2 = vert_img1.resize((90, 90))
        vert_img3 = Image.new('RGB', (100, 100), color='black')

        h1 = dhash_vertical(vert_img1)
        h2 = dhash_vertical(vert_img2)
        h3 = dhash_vertical(vert_img3)
