...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create a vertically split image for vertical dhash
        self.vertical_img = Image.new('RGB', (100, 100), color='black')
        for x in range(100):
            for y in range(50, 100):
                self.vertical_img.putpixel((x, y), (255, 255, 255))
        self.vertical_img_small = self.vertical_img.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        h1 = dhash_vertical(self.vertical_img)
        h2 = dhash_vertical(self.vertical_img_small)
