...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        self.vertical_img1 = Image.new('RGB', (100, 100), color='black')
        d_vert = ImageDraw.Draw(self.vertical_img1)
        d_vert.rectangle([0, 50, 100, 100], fill='white')
        self.vertical_img2 = self.vertical_img1.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        h1 = dhash_vertical(self.vertical_img1)
