...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create vertically split image for dhash_vertical
        self.img_vertical1 = Image.new('RGB', (100, 100), color='black')
        for x in range(100):
            for y in range(50, 100):
                self.img_vertical1.putpixel((x, y), (255, 255, 255))
        self.img_vertical2 = self.img_vertical1.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        h1 = dhash_vertical(self.img_vertical1)
