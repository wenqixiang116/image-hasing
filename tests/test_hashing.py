...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create image with horizontal split
        self.img_hsplit = Image.new('RGB', (100, 100), color='black')
        for y in range(50, 100):
            for x in range(100):
                self.img_hsplit.putpixel((x, y), (255, 255, 255))
        self.img_hsplit2 = self.img_hsplit.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        h1 = dhash_vertical(self.img_hsplit)
        h2 = dhash_vertical(self.img_hsplit2)
