...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create an image with vertical variations for dhash_vertical testing
        self.img_v = Image.new('RGB', (100, 100), color='white')
        d_v = ImageDraw.Draw(self.img_v)
        d_v.rectangle([0, 0, 100, 50], fill='black')

        self.img_v2 = self.img_v.resize((90, 90))
        self.img_v3 = Image.new('RGB', (100, 100), color='black')
