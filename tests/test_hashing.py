...
class TestHashing(unittest.TestCase):
    ...
    def test_dhash_vertical(self):
        # Create an image with vertical color variation
        img_vert1 = Image.new('RGB', (100, 100), color='white')
        d1 = ImageDraw.Draw(img_vert1)
        d1.rectangle([0, 50, 100, 100], fill='black')

        img_vert2 = img_vert1.resize((90, 90))
        img_vert3 = Image.new('RGB', (100, 100), color='black')

        h1 = dhash_vertical(img_vert1)
