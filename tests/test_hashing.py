...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        self.img4 = Image.new('RGB', (100, 100), color='black')
        d4 = ImageDraw.Draw(self.img4)
        d4.rectangle([0, 50, 100, 100], fill='white')
    ...
    def test_dhash_vertical(self):
        h1 = dhash_vertical(self.img4)
        h2 = dhash_vertical(self.img4.resize((90, 90)))
        h3 = dhash_vertical(self.img3)

        self.assertTrue(h1.shape == (8, 8))
        self.assertTrue(h1.any()) # Hash should not be all zero for vertically split image
        self.assertLess(hamming_distance(h1, h2), 5)
