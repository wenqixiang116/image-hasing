...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Vertically split image (top half black, bottom half white) for vertical gradient
        ...
        # Similar vertically split image
        self.img_vsplit_similar = self.img_vsplit.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        ...
        h2 = dhash_vertical(self.img_vsplit_similar)
        h3 = dhash_vertical(self.img1)

        self.assertTrue(h1.shape == (8, 8))
        self.assertFalse(np.all(h1 == False)) # Not all zeros due to vertical variation
        self.assertLess(hamming_distance(h1, h2), 5)
        self.assertGreater(hamming_distance(h1, h3), 10)
