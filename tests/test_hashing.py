...
class TestHashing(unittest.TestCase):
    ...
    def test_dhash_vertical(self):
        # Create a vertically split image to avoid all-zero hashes
        img_vsplit = Image.new('RGB', (100, 100), color='white')
        d = ImageDraw.Draw(img_vsplit)
        d.rectangle([0, 50, 100, 100], fill='black')

        img_vsplit_resized = img_vsplit.resize((90, 90))

        h1 = dhash_vertical(img_vsplit)
        h2 = dhash_vertical(img_vsplit_resized)
        h3 = dhash_vertical(self.img3) # Black image
