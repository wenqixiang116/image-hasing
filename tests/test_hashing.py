...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create an image with vertical color variation for dhash_vertical testing
        self.img4 = Image.new('RGB', (100, 100), color='white')
        d4 = ImageDraw.Draw(self.img4)
        d4.rectangle([0, 50, 100, 100], fill='black')
        self.img5 = self.img4.resize((90, 90))
