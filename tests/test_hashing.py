...
from image_hashing.hashing import average_hash, difference_hash, phash, hamming_distance, hash_to_hex, hex_to_hash, difference_hash_vertical, marr_hildreth_hash
...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create vertically varied images for dhash_vertical test
        self.img_vertical = Image.new('RGB', (100, 100), color='white')
        d2 = ImageDraw.Draw(self.img_vertical)
        d2.rectangle([0, 50, 100, 100], fill='black')
        self.img_vertical_2 = self.img_vertical.resize((90, 90))
    ...
    def test_difference_hash_vertical(self):
        h1 = difference_hash_vertical(self.img_vertical)
        h2 = difference_hash_vertical(self.img_vertical_2)
        h3 = difference_hash_vertical(self.img3)
