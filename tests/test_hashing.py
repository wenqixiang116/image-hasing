...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create a vertically split image for dhash_vertical testing
        self.img_v_split = Image.new('RGB', (100, 100), color='black')
        d_v = ImageDraw.Draw(self.img_v_split)
        d_v.rectangle([0, 50, 100, 100], fill='white')
        self.img_v_split_resized = self.img_v_split.resize((90, 90))
    ...
    def test_dhash_vertical(self):
        h1 = dhash_vertical(self.img_v_split)
        h2 = dhash_vertical(self.img_v_split_resized)
