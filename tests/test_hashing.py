...
class TestHashing(unittest.TestCase):
    def setUp(self):
        ...
        # Create an image with vertical variation for vertical dhash testing
    ...
    def test_dhash_vertical(self):
        ...
        h2 = dhash_vertical(self.img_vert.resize((90, 90)))
    ...
    def test_marr_hildreth_hash(self):
        ...
        self.assertTrue(h1.shape == (8, 8))
        self.assertLess(hamming_distance(h1, h2), 20)  # Marr-Hildreth can have larger distance for scaling
        self.assertGreater(hamming_distance(h1, h3), 5)
