...
class TestNewAlgorithms(unittest.TestCase):
    ...
    def test_dhash_vertical(self):
        # Image with vertical color variation
        ...
        h2 = dhash_vertical(img_vert)
        self.assertEqual(h, h2)

        # Ensure that it's different from an all-black image
        h_black = dhash_vertical(Image.new('RGB', (100, 100), color='black'))
        self.assertNotEqual(h, h_black)
