...
class TestNewAlgorithms(unittest.TestCase):
    ...
    def test_dhash_vertical(self):
        # Create an image with vertical variation (top half black, bottom half white)
        ...
        # Test diff with horizontal split (might not have vertical variation, but diff image)
