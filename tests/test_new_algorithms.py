...
class TestNewAlgorithms(unittest.TestCase):
    def setUp(self):
        ...
        self.v_split_image = Image.new('RGB', (100, 100), color='black')
        d = ImageDraw.Draw(self.v_split_image)
    ...
    def test_dhash_vertical(self):
        h = dhash_vertical(self.v_split_image)
        self.assertIsInstance(h, str)
        self.assertEqual(len(h), 16)

        h2 = dhash_vertical(self.v_split_image)
        self.assertEqual(h, h2)
