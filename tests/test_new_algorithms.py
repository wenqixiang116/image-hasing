...
class TestNewAlgorithms(unittest.TestCase):
    def setUp(self):
        ...
        # Vertically split image (for testing vertical dhash)
        self.image_vert = Image.new('RGB', (100, 100), color='black')
        for x in range(100):
            for y in range(50, 100):
                self.image_vert.putpixel((x, y), (255, 255, 255))
    ...
    def test_dhash_vertical(self):
        # Note: testing with a vertically split image to ensure we get vertical variation
