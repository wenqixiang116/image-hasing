...
class TestNewAlgorithms(unittest.TestCase):
    def setUp(self):
        ...
        # Create a completely different image (white on top, black on bottom)
        self.image_vertical2 = Image.new('RGB', (100, 100), color='white')
        for x in range(100):
            for y in range(50, 100):
                self.image_vertical2.putpixel((x, y), (0, 0, 0))
    ...
    def test_dhash_vertical(self):
        ...
        # Test diff image
        h_diff = dhash_vertical(self.image_vertical2)
        self.assertNotEqual(h, h_diff)
    ...
    def test_marr_hildreth_hash(self):
        ...
        # Test diff image
        h_diff = marr_hildreth_hash(self.image2)
        self.assertNotEqual(h, h_diff)
