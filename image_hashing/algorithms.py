...
def marr_hildreth_hash(image, alpha=2.5, scale=3, hash_size=8):
    """
    ...
    # Grayscale and convert to float
    image = image.convert("L")
    ...
    # Subsample to hash_size
    blocks = blocks[::scale, ::scale]

    # Detect zero-crossings (simplified as > 0 based on common implementations)
    diff = blocks > 0
